...
const componentScriptUrl = "" + new URL("bene-components.iife-_s6a4u55.js", import.meta.url).href;
...
const componentStyleUrl = "" + new URL("bene-components-DPlOXCp8.css", import.meta.url).href;
...
var epubCfiResolver;
var hasRequiredEpubCfiResolver;
function requireEpubCfiResolver() {
  if (hasRequiredEpubCfiResolver) return epubCfiResolver;
  hasRequiredEpubCfiResolver = 1;
  ...
  class CFI2 {
    ...
    getChildNodeByCFIIndex(dom, parentNode, index, offset) {
      const children2 = parentNode.childNodes;
      if (!children2.length) return { node: parentNode, offset: 0 };
      if (index <= 0) {
        return { node: children2[0], relativeToNode: "before", offset: 0 };
      }
      var cfiCount = 0;
      var lastChild;
      var i, child;
  ...
  epubCfiResolver = CFI2;
  return epubCfiResolver;
}
var epubCfiResolverExports = requireEpubCfiResolver();
const CFI = /* @__PURE__ */ getDefaultExportFromCjs(epubCfiResolverExports);
function addAnnotations(document2, state, chapterHref) {
  ...
  for (let annot of rendition.annotations) {
    ...
    let resolved = cfi.resolveLast(document2);
...
function ToolbarInner() {
  ...
  return [(() => {
    const _el$ = _tmpl$(), _el$2 = _el$.firstChild, _el$3 = _el$2.nextSibling, _el$4 = _el$3.nextSibling, _el$5 = _el$4.nextSibling, _el$6 = _el$5.nextSibling;
    _el$6.firstChild;
    insert(_el$, (() => {
      const _c$ = memo(() => !!findNavItem(state));
      return () => _c$() && [(() => {
        const _el$14 = _tmpl$4();
        _el$14.$$click = () => setState({
    ...
    const _el$8 = _tmpl$2(), _el$9 = _el$8.firstChild, _el$10 = _el$9.nextSibling, _el$11 = _el$10.nextSibling, _el$12 = _el$11.nextSibling;
    _el$9.$$click = () => setState({
      zoomLevel: clampZoom(state.zoomLevel - 1)
    });
    _el$11.$$click = () => setState({
      zoomLevel: clampZoom(state.zoomLevel + 1)
    });
    _el$12.$$input = (e) => {
    ...
    insert(_el$12, () => ZOOM_LEVELS.map((n, i) => (() => {
      const _el$16 = _tmpl$6(), _el$17 = _el$16.firstChild;
      insert(_el$16, n, _el$17);
      createRenderEffect(() => _el$16.value = i.toString());
      return _el$16;
    })()));
    createRenderEffect(() => _el$12.value = state.zoomLevel);
    return _el$8;
  })(), (() => {
    const _el$13 = _tmpl$3();
    insert(_el$13, (() => {
      const _c$2 = memo(() => !!state.url);
      return () => _c$2() ? (() => {
        const _el$18 = _tmpl$7();
        _el$18.$$click = () => downloadEpub(state.url);
        return _el$18;
      })() : null;
    })());
    return _el$13;
...
function Toolbar() {
  ...
  return (() => {
    const _el$19 = _tmpl$8();
    insert(_el$19, (() => {
      const _c$3 = memo(() => state.type === "ready");
...
function Nav(props) {
  ...
  return (() => {
    const _el$20 = _tmpl$9();
    const _ref$ = iframeRef;
    typeof _ref$ === "function" ? use(_ref$, _el$20) : iframeRef = _el$20;
    createRenderEffect((_p$) => {
      const _v$ = !!state.showNav, _v$2 = navUrl();
      _v$ !== _p$._v$ && _el$20.classList.toggle("show", _p$._v$ = _v$);
      _v$2 !== _p$._v$2 && setAttribute(_el$20, "src", _p$._v$2 = _v$2);
      return _p$;
    }, {
      _v$: void 0,
      _v$2: void 0
...
function Content(props) {
  ...
  return (() => {
    const _el$21 = _tmpl$10();
    const _ref$2 = iframeRef;
    typeof _ref$2 === "function" ? use(_ref$2, _el$21) : iframeRef = _el$21;
    createRenderEffect(() => setAttribute(_el$21, "src", chapterUrl()));
    return _el$21;
  })();
}
function ViewerInner() {
  ...
  return [memo((() => {
    const _c$4 = memo(() => !!findNavItem(state));
    return () => _c$4() && createComponent(Nav, {
      navigateEvent,
      get navItem() {
...
function Loader() {
  ...
  let ref;
  return (() => {
    const _el$22 = _tmpl$11();
    insert(_el$22, (() => {
      const _c$5 = memo(() => state.type === "waiting");
      return () => _c$5() ? ["Drag an EPUB file into the window, or click here to upload:", " ", (() => {
        const _el$23 = _tmpl$12();
        _el$23.$$click = (e) => {
          e.preventDefault();
          ref.click();
        };
        _el$23.style.setProperty("opacity", "0.4");
        _el$23.style.setProperty("top", "2px");
        _el$23.style.setProperty("left", "3px");
        return _el$23;
      })(), (() => {
        const _el$24 = _tmpl$13();
        _el$24.addEventListener("change", (event) => {
        ...
        const _ref$3 = ref;
        typeof _ref$3 === "function" ? use(_ref$3, _el$24) : ref = _el$24;
        _el$24.style.setProperty("display", "none");
        return _el$24;
      })()] : (() => {
        const _c$6 = memo(() => state.type === "error");
        return () => _c$6() ? (() => {
          const _el$25 = _tmpl$14();
          _el$25.firstChild;
          insert(_el$25, () => state.error, null);
          return _el$25;
        })() : null;
      })();
    })());
...
function Viewer() {
  const [state] = useContext(StateContext);
  return (() => {
    const _el$27 = _tmpl$15();
    insert(_el$27, (() => {
      const _c$7 = memo(() => state.type === "ready");
      return () => _c$7() ? createComponent(ViewerInner, {}) : createComponent(Loader, {});
    })());
    return _el$27;
  })();
}
...
function App() {
  ...
  return createComponent(StateContext.Provider, {
    ...
    get children() {
      const _el$28 = _tmpl$16();
      insert(_el$28, createComponent(Toolbar, {}), null);
      insert(_el$28, createComponent(Viewer, {}), null);
      return _el$28;
    }
  });
}
...
//# sourceMappingURL=index-CXF15XAH.js.map
