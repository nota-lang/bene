...
const _tmpl$ = /* @__PURE__ */ template(`<iframe title="Bene Reader"src=bene-reader/index.html referrerpolicy=no-referrer>`);
async function registerServiceWorker(post) {
  ...
  const prevRegistration = registrations.find((reg) => reg.active && reg.active.scriptURL === workerUrl);
  if (prevRegistration !== void 0) await prevRegistration.unregister();
...
//# sourceMappingURL=index-9bKaY5Mn.js.map
