...
const ZIPS = [{
  ...
  title: "Programming Languages: Applications and Interpretation (Shriram Krishnamurthi, 2023)"
}];
function ProvidedEpubs(props) {
  ...
  {
    onMount(() => fetchZip("refs.epub"));
  }
  return (() => {
    const _el$ = _tmpl$();
    _el$.firstChild;
    _el$.addEventListener("change", (event) => fetchZip(event.target.value));
    insert(_el$, createComponent(For, {
      each: ZIPS,
      children: (zip) => (() => {
        const _el$3 = _tmpl$2();
        insert(_el$3, () => zip.title);
        createRenderEffect(() => _el$3.value = zip.file);
        return _el$3;
      })()
    }), null);
    return _el$;
...
function CustomEpub(props) {
  ...
  onMount(() => {
    ...
    dropEl.addEventListener("drop", (event) => {
      ...
      if ((files == null ? void 0 : files.length) && files.length > 0) {
        const file = files[0];
  ...
  return (() => {
    const _el$4 = _tmpl$3();
    const _ref$ = dropEl;
    typeof _ref$ === "function" ? use(_ref$, _el$4) : dropEl = _el$4;
    return _el$4;
  })();
}
function App() {
  let iframe;
  let [newEpub, setNewEpub] = createSignal();
  onMount(async () => {
  ...
  return (() => {
    const _el$5 = _tmpl$4(), _el$6 = _el$5.firstChild, _el$7 = _el$6.nextSibling, _el$8 = _el$7.nextSibling;
    insert(_el$7, (() => {
      const _c$ = createMemo(() => !!newEpub());
      return () => _c$() ? [createComponent(ProvidedEpubs, {
        get newEpub() {
          return newEpub();
        }
      }), createComponent(CustomEpub, {
        get newEpub() {
          return newEpub();
        }
      })] : null;
    ...
    const _ref$2 = iframe;
    typeof _ref$2 === "function" ? use(_ref$2, _el$8) : iframe = _el$8;
    return _el$5;
  })();
}
render(() => createComponent(App, {}), document.getElementById("root"));
//# sourceMappingURL=index-UrYlP4jm.js.map
