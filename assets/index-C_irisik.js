...
async function registerServiceWorker() {
  ...
  logChannel.addEventListener("message", (event) => console.debug("Service worker:", event.data));
  ...
  if (existingRegistration) {
    ...
    console.debug(`Registered worker at scope ${registration.scope}, waiting for it to activate.`, registration);
    await workerReady;
...
//# sourceMappingURL=index-C_irisik.js.map
